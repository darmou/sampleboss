...
ADMINS = (
    # ('Daryl Moulder', 'dmoulder@qtome.com'),
)

MANAGERS = ADMINS 
BOSS_API_KEY = 'dj0yJmk9cFdSQ2VOd21yVFJUJmQ9WVdrOU5teEdhbFptTjJFbWNHbzlNVGczTURJNE5qYzJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD0xZA--' 
BOSS_API_SECRET = '1decae31815ce406da01a437c3a030759040e7c5' 
BOSS_RESULTS_PER_PAGE = 10 
INTERNAL_IPS = ('60.240.141.168','192.168.73.236','192.168.72.34')

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'darmou_sampleboss', # Or path to database file if using sqlite3.
        'USER': 'darmou_sampleboss', # Not used with sqlite3.
        'PASSWORD': '875ad1dc', # Not used with sqlite3.
        'HOST': '', # Set to empty string for localhost. Not used with sqlite3.
        'PORT': '', # Set to empty string for default. Not used with sqlite3.
    }
}

# Local time zone for this installation. Choices can be found here: http://en.wikipedia.org/wiki/List_of_tz_zones_by_name although not all choices may be available on all operating systems. On Unix systems, a value of None will cause Django to use the same 
...
MEDIA_ROOT = '/home/darmou/webapps/sampleboss_media'
...
MEDIA_URL = 'http://sampleboss.qtome.com/media/'

# Absolute path to the directory static files should be collected to. Don't put anything in this directory yourself; store your static files in apps' "static/" subdirectories and in STATICFILES_DIRS. Example: "/home/media/media.lawrence.com/static/"
STATIC_ROOT = '/home/darmou/webapps/sampleboss_static'

# URL prefix for static files. Example: "http://media.lawrence.com/static/"
STATIC_URL = 'http://sampleboss.qtome.com/static/'
...
SECRET_KEY = 'j52al^b0m4k_0if78@%jrh@!1hyu=ltws*if*4ebhg)42b4-x('
...
ROOT_URLCONF = 'samplebossproject.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'samplebossproject.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates". Always use forward slashes, even on Windows.
    "/home/darmou/webapps/sampleboss_media/django_templates"
